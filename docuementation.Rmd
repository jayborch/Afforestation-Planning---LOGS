...
broad_scale_model <- rast("data/broad_scale_rf_prob.tif")  # adjust path if needed
...
raster_pal <- colorNumeric(palette = "viridis",
...
leaflet() %>%
  ...
  addRasterImage(broad_scale_model,
                 colors = raster_pal,
                 opacity = 0.7,
                 project = T,
                 group = "Afforestation ecological suitability") %>%
  
  # Add forest polygons
  addPolygons(data = skoglendi_wgs84,
              color = "darkgreen",
              fillColor = "green",
              fillOpacity = 0.4,
              weight = 1,
  ...
  addPolygons(data = natturu_birki_wgs84,
              color = "brown",
              fillColor = "orange",
              fillOpacity = 0.4,
              weight = 1,
  ...
  # Add a legend for the raster
  addLegend(pal = raster_pal,
